...
d=$t/save-as
$PIXELFORGE -b sprites/1empty3.pixelforge --save-as "$d/image00.png" || exit 1
expect "image00.png
image01.png
...
$PIXELFORGE -b sprites/1empty3.pixelforge --ignore-empty --save-as $d/image00.png || exit 1
expect "image00.png
image02.png" "list_files $d"
...
$PIXELFORGE -b sprites/1empty3.pixelforge --split-layers --save-as $d/layer.png || exit 1
...
d=$t/save-as-layer
$PIXELFORGE -b sprites/1empty3.pixelforge --save-as $d/layer-{layer}.gif || exit 1
expect "layer-bg.gif
...
$PIXELFORGE -b sprites/1empty3.pixelforge --save-as "$d/frame8-test.png" || exit 1
...
d=$t/save-as-frame-0
$PIXELFORGE -b sprites/1empty3.pixelforge --save-as "$d/frame-0.png" || exit 1
expect "frame-0.png
frame-1.png
...
$PIXELFORGE -b sprites/1empty3.pixelforge --save-as "$d/frame-00.png" || exit 1
expect "frame-00.png
frame-01.png
...
$PIXELFORGE -b sprites/1empty3.pixelforge --save-as "$d/frame-001.png" || exit 1
...
$PIXELFORGE -b sprites/1empty3.pixelforge --save-as "$d/frame-0032.png" || exit 1
...
d=$t/save-as-trim
$PIXELFORGE -b --trim sprites/1empty3.pixelforge --save-as "$d/trim-000.png" || exit 1
expect "trim-000.png
trim-001.png
trim-002.png" "list_files $d"
cat >$d/compare.lua <<EOF
local a = app.open("sprites/1empty3.pixelforge")
assert(a.width == 32)
assert(a.height == 32)
...
$PIXELFORGE -batch -split-layers -trim sprites/1empty3.pixelforge -save-as "$d/{layer}{frame}.png" || exit 1
expect "bg0.png
bg1.png
bg2.png
fg0.png
...
# https://github.com/pixelforge/pixelforge/issues/591

d=$t/save-as-without-path
mkdir $d
oldwd=$(pwd $PWDARG)
cd $d
$PIXELFORGE -b -split-layers $oldwd/sprites/abcd.pixelforge -save-as issue591.png || exit 1
if [[ ! -f "issue591 (a).png" ||
      ! -f "issue591 (b).png" ||
      ! -f "issue591 (c).png" ||
...
# https://github.com/pixelforge/pixelforge/issues/2084#issuecomment-525835889
...
$PIXELFORGE -b sprites/groups2.pixelforge -layer \* -save-as "$d/g2-all.png" || exit 1
$PIXELFORGE -b sprites/groups2.pixelforge -layer \* -ignore-layer items -save-as "$d/g2-all-without-items.png" || exit 1
$PIXELFORGE -b sprites/groups2.pixelforge -layer \* -ignore-layer gun -save-as "$d/g2-all-without-gun1.png" || exit 1
$PIXELFORGE -b sprites/groups2.pixelforge -layer \* -ignore-layer sword -save-as "$d/g2-all-without-sword1.png" || exit 1
$PIXELFORGE -b sprites/groups2.pixelforge -layer \* -ignore-layer items/gun -save-as "$d/g2-all-without-gun2.png" || exit 1
$PIXELFORGE -b sprites/groups2.pixelforge -layer \* -ignore-layer items/sword -save-as "$d/g2-all-without-sword2.png" || exit 1
$PIXELFORGE -b sprites/groups2.pixelforge -layer \* -ignore-layer player -save-as "$d/g2-all-without-player.png" || exit 1
$PIXELFORGE -b sprites/groups2.pixelforge -layer player -save-as "$d/g2-player.png" || exit 1
$PIXELFORGE -b sprites/groups2.pixelforge -layer items -save-as "$d/g2-items.png" || exit 1
$PIXELFORGE -b sprites/groups2.pixelforge -layer items/\* -save-as "$d/g2-items-all.png" || exit 1
$PIXELFORGE -b sprites/groups2.pixelforge -layer sword -save-as "$d/g2-sword.png" || exit 1
$PIXELFORGE -b sprites/groups2.pixelforge -layer gun -save-as "$d/g2-gun.png" || exit 1

$PIXELFORGE -b sprites/groups3abc.pixelforge -layer a -save-as "$d/g3-a.png" || exit 1
$PIXELFORGE -b sprites/groups3abc.pixelforge -layer b -save-as "$d/g3-b.png" || exit 1
$PIXELFORGE -b sprites/groups3abc.pixelforge -layer c -save-as "$d/g3-c.png" || exit 1
$PIXELFORGE -b sprites/groups3abc.pixelforge -layer a/\* -save-as "$d/g3-a-all.png" || exit 1
$PIXELFORGE -b sprites/groups3abc.pixelforge -layer b/\* -save-as "$d/g3-b-all.png" || exit 1
$PIXELFORGE -b sprites/groups3abc.pixelforge -layer c/\* -save-as "$d/g3-c-all.png" || exit 1
$PIXELFORGE -b sprites/groups3abc.pixelforge -layer a/a -save-as "$d/g3-aa.png" || exit 1
$PIXELFORGE -b sprites/groups3abc.pixelforge -layer b/a -save-as "$d/g3-ba.png" || exit 1
$PIXELFORGE -b sprites/groups3abc.pixelforge -layer c/a -save-as "$d/g3-ca.png" || exit 1
$PIXELFORGE -b sprites/groups3abc.pixelforge -layer a/b -save-as "$d/g3-ab.png" || exit 1
$PIXELFORGE -b sprites/groups3abc.pixelforge -layer b/b -save-as "$d/g3-bb.png" || exit 1
$PIXELFORGE -b sprites/groups3abc.pixelforge -layer c/b -save-as "$d/g3-cb.png" || exit 1
$PIXELFORGE -b sprites/groups3abc.pixelforge -layer a/c -save-as "$d/g3-ac.png" || exit 1
$PIXELFORGE -b sprites/groups3abc.pixelforge -layer b/c -save-as "$d/g3-bc.png" || exit 1
$PIXELFORGE -b sprites/groups3abc.pixelforge -layer c/c -save-as "$d/g3-cc.png" || exit 1

cat >$d/compare.lua <<EOF
dofile('scripts/test_utils.lua')

local g2 = app.open("sprites/groups2.pixelforge")
local g3 = app.open("sprites/groups3abc.pixelforge")
...
# Test --save-as {title}
# https://github.com/pixelforge/pixelforge/issues/2442
# https://community.pixelforge.org/t/16491

d=$t/save-as-title
$PIXELFORGE -b sprites/groups2.pixelforge -save-as "$d/{title}.png" || exit 1
$PIXELFORGE -b sprites/groups3abc.pixelforge -save-as "$d/{title}.png" || exit 1
$PIXELFORGE -b sprites/link.pixelforge -save-as "$d/{title}{frame}.png" || exit 1
expect "groups2.png
groups3abc.png
link0.png
...
$PIXELFORGE -b sprites/groups2.pixelforge \
             sprites/groups3abc.pixelforge \
             sprites/link.pixelforge -save-as "$d/{title}-{frame1}.png" || exit 1
...
# https://community.pixelforge.org/t/17253

d=$t/save-as-1-as-frame1-ok
$PIXELFORGE -b sprites/1empty3.pixelforge \
...
# Test https://github.com/pixelforge/pixelforge/issues/3733#issuecomment-1489720933
#      https://github.com/pixelforge/pixelforge/issues/3733#issuecomment-1494682407
...
# https://github.com/pixelforge/pixelforge/issues/3801

d=$t/save-as-with-slice
$PIXELFORGE -b sprites/slices.pixelforge -save-as $d/{slice}.png
expect "line.png
square.png" "list_files $d"

# Test https://github.com/pixelforge/pixelforge/issues/3622
# Test that -save-as -tag will save the right tag frames in webp file format

d=$t/save-as-tag-webp
$PIXELFORGE -b -frame-tag "a" sprites/1empty3.pixelforge -save-as $d/save-as-tag.webp || exit 1
...
# https://github.com/pixelforge/pixelforge/issues/3827
d=$t/save-selection-to-gif
mkdir $d
cat >$d/save.lua <<EOF
local a = app.open("sprites/tags3.pixelforge")
assert(a.width == 4)
assert(a.height == 4)
...
assert(b.height == 2)
EOF
"$PIXELFORGE" -b -script "$d/save.lua" || exit 1

# Saving moving slice
d=$t/save-moving-slice
$PIXELFORGE -b sprites/slices-moving.pixelforge -slice square -save-as $d/output.gif || exit 1
$PIXELFORGE -b sprites/slices-moving.pixelforge -slice square -save-as $d/output.png || exit 1
$PIXELFORGE -b sprites/slices-moving.pixelforge -scale 2 -slice square -save-as $d/scaled.gif || exit 1
$PIXELFORGE -b sprites/slices-moving.pixelforge -scale 2 -slice square -save-as $d/scaled.png || exit 1
cat >$d/compare.lua <<EOF
...
$PIXELFORGE -b sprites/tags3x123reps.pixelforge --play-subtags --save-as $d/image{frame01}.png || exit 1
expect "image01.png
image02.png
image03.png
image04.png
...
cat >$d/compare.lua <<EOF
local src = app.open("sprites/tags3x123reps.pixelforge")
src:flatten()
