...
#ifndef DIO_PIXELFORGE_COMMON_H_INCLUDED
#define DIO_PIXELFORGE_COMMON_H_INCLUDED
#pragma once
...
struct PixelForgeHeader {
  ...
  uint16_t depth;
  uint32_t flags;
  uint16_t speed; // Deprecated, use "duration" of PixelForgeFrameHeader
  uint32_t next;
  uint32_t frit;
