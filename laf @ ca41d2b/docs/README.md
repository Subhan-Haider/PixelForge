...
[PixelForge](https://www.pixelforge.org/) but we want to make it available
...
CPU [endianness](https://en.wikipedia.org/wiki/Endianness) (defined in [base/config.h](https://github.com/pixelforge/laf/blob/main/base/config.h.cmakein)):
