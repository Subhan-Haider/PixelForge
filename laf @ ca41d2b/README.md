...
[![build](https://github.com/pixelforge/laf/workflows/build/badge.svg)](https://github.com/pixelforge/laf/actions?query=workflow%3Abuild)
...
* [Documentation](https://pixelforge.github.io/laf/)
...
from branch `pixelforge-m124`. You can check the pixelforge/skia fork
which includes a [release with pre-built versions](https://github.com/pixelforge/skia/releases), or
the check the [instructions to compile skia](https://github.com/pixelforge/skia#readme) from scratch.
...
```
git clone --recursive https://github.com/pixelforge/laf.git
cd laf
...
* Tests use the [Google Test](https://github.com/pixelforge/googletest/tree/master/googletest)
  framework by Google Inc. licensed under
  [a BSD-like license](https://github.com/pixelforge/googletest/blob/master/googletest/LICENSE).
* Color spaces, `gfx::Region`, and the `laf::os` library use code from
  the [Skia library](https://skia.org) by Google Inc. licensed under
  [a BSD-like license](https://github.com/pixelforge/skia/blob/master/LICENSE)
  and several other [third-party libraries/licenses](https://github.com/pixelforge/skia/tree/master/third_party).
